...
### PUREE-V01 — glass-cling pumpkin purée preparation

`B-20260904-PUMPPURE-V01-01` adapts PR-0027 from the named Boiron purée to the arrived KoRo 100% purée and from the 1,000 g source base to 286 g. The working formula is 286 g purée, 64 g sugar split 32/32, and 2 g NH pectin. Exact proportional values at a 2 g pectin scale are 285.714 g purée and 64.286 g sugar; the whole-gram rounding is disclosed. The professional source's 50°C addition, 103°C endpoint, covered cooling, and cold smoothing are retained.
