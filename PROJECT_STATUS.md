...
- **Latest consequential change:** KoRo pumpkin purée arrived; PB-001 now has separate source-traced glass-cling purée and pumpkin-spice syrup batches, while the unexecuted combined sauce and original house drink build are superseded
...
|---|---|---|---|---|
| PB-001 — Pumpkin Purée Preparation and Spice Syrup | Materials/readiness stage before two component pilots | KoRo 100% pumpkin purée arrived; PR-0027 Boiron pumpkin confit and PR-0028 Vitamix pumpkin-spice syrup selected; FONTE control retained | PUREE-V01 and SYRUP-V01 PLANNED; GC-20260830-PB001-01 revised; combined sauce V01/V02 and AT-20260830-001 superseded unexecuted | Record physical KoRo can; obtain/confirm pectin, control, spices, scale/thermometer and measures; execute components separately |
...
| PB-001 product development | Two component batches/pilot planned | PUREE-V01: whole-gram KoRo adaptation of Boiron's pumpkin confit; SYRUP-V01: exact unscaled Vitamix syrup; KoRo and FONTE controls | Record arrived can, complete the revised readiness list, execute the components separately, then run GC-20260830-PB001-01 |
...
|---|---|---|---|---|---|
| Pumpkin | PR-0027 exact Boiron pumpkin confit/compote; PR-0028 exact Vitamix syrup; earlier PR-0013/0014/0015 retained | Dual-format PB-001 active | B-20260904-PUMPPURE-V01-01 and B-20260904-PUMPSYR-V01-01 planned | Replacement source-only matcha application not yet opened | Does separate high-pumpkin cling plus adjustable syrup justify the added service complexity? |
...
- Does PUREE-V01 remain squeezeable while outperforming unmodified KoRo and FONTE on glass-wall retention?
- Does SYRUP-V01 provide useful, adjustable sweetness and spice without sediment or matcha domination?
...
- **B-20260904-PUMPPURE-V01-01:** PR-0027 whole-gram KoRo adaptation — 286 g purée / 64 g sugar split 32/32 / 2 g NH pectin; source 50°C addition and 103°C finish retained.
- **B-20260904-PUMPSYR-V01-01:** exact unscaled PR-0028 Vitamix syrup — 300 ml water / 120 ml KoRo purée / 110 g sugar / measured vanilla, cinnamon, allspice, and ginger; light simmer about 5 minutes.
- **GC-20260830-PB001-01:** FONTE vs unmodified KoRo vs PUREE-V01 comparative cling/squeeze pilot; no arbitrary numerical threshold. SYRUP-V01 is excluded from cling scoring.
...
| BUY | NH pectin | 1 × Sosa Fruit Pectin NH; PUREE-V01 requires 2 g and no substitute is authorised |
| BUY/CONFIRM | Granulated sugar | At least 200 g one recorded product; exact combined batch requirement is 174 g |
| BUY/CONFIRM | Syrup flavourings | Vanilla extract; ground cinnamon; ground allspice/Piment; ground ginger — exact products to record |
...
| NOT REQUIRED | Milchmädchen / Ostmann mix / sous vide / vacuum bags | Belong to the superseded sauce route or unrelated later work; do not buy/use for current PB-001 batches |
...
- Physical labels/lots/prices for KoRo, FONTE, NH pectin, sugar, vanilla, cinnamon, allspice, ginger, and matcha.
...
- PUREE-V01 actual ingredient masses, yield, Brix, 50°C/103°C process times, cold texture, squeeze performance, labour, and deviations.
- SYRUP-V01 actual mass of 120 ml KoRo, yield, Brix, light-simmer time/temperature, pourability, settling, flavour, labour, and deviations.
...
- The health review does not authorise a “healthy,” “healthier,” “low sugar,” or similar claim. PUREE-V01 and SYRUP-V01 therefore retain the sucrose specified by their professional source formulations; alternatives remain a later, separately sourced comparison only after flavour, texture, and service function pass.
...
2. Buy/confirm Sosa Fruit Pectin NH, FONTE control, 200 g granulated sugar, vanilla extract, ground cinnamon, ground allspice/Piment, ground ginger, standard 1/2 and 1 tsp measures, the two required containers, 0.1 g scale, 103°C-capable thermometer, and dosing syringe.
3. Prepare PUREE-V01 exactly as written, then run KoRo vs PUREE-V01 vs FONTE through GC-20260830-PB001-01. Separately execute the unscaled Vitamix SYRUP-V01 only if a full 120 ml KoRo portion remains; record, do not improvise.
