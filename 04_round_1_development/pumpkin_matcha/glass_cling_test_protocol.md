...
For the first pilot these are fixed as FONTE Gourmet Pumpkin Spice Sauce (`SRC-2026-029` to `SRC-2026-031`), unmodified KoRo Kürbispüree (`SRC-2026-026`/`027`), and the café-practical Boiron-derived `B-20260905-PUMPPURE-V03-01`. The separate Vitamix pumpkin-spice syrup is excluded because its function is pourable sweetness, not cling. See `GC-20260830-PB001-01.md`.
