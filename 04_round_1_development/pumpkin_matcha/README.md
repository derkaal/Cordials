...
| Development stage | Record/status |
|---|---|
| Product Brief | `PB-001.md` — ACTIVE |
| Professional Research | `../../01_research/pumpkin_matcha_professional_research.md` — IN PROGRESS |
| Candidate Formulations | V02 — practical approximately half-scale PR-0014 adaptation; no texture modifier |
| Experimental Batches | `B-20260830-PUMPMAT-V01-01` — SUPERSEDED BEFORE EXECUTION; `B-20260830-PUMPMAT-V02-01` — PLANNED |
...
No shelf-life or safety outcome is approved. Source-stated storage periods in professional references are evidence of what those sources say, not validated guidance for a future PB-001 formulation.
